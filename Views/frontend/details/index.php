...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
        ...
        <div class="col-lg-7 pb-5">
            ...
            ?> -->
            <input type="text" id="soLuongTonId" value="<?php echo $findProduct['soluongton']?>">
            ...
            <form action="index.php?controller=cart&action=store" method="post">
                ...
                <div class="d-flex mb-3">
                    <p class="text-dark font-weight-medium mb-0 mr-3">Kích cở:</p>
                    <?php
                    // size php
            ...
            <div class="d-flex pt-2">
                <p class="text-dark font-weight-medium mb-0 mr-2">Tương tác:</p>
