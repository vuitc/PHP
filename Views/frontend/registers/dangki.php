...
<body>
    <div class="container">
        <form id="signup" class="form" method="post" action="index.php?controller=register&action=dangki_act">
            <h1>Tạo tài khoản</h1>
            ...
            <div class="form-field">
                <span>Đã có tài khoản </span><a href="index.php?controller=register&action=sign_in">Đăng nhập ngay</a>
            </div>
        </form>
    </div>
    <!-- <script>
