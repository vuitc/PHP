...
<body>
    <div class="container">
        <form id="signup" class="form" method="post" action="index.php?controller=register&action=changePass_act">
            <h1>Đổi mật khẩu</h1>
            <?php
            ...
            <div class="form-field">
                <label for="password1">Password mới:</label>
                <input type="password" name="password1" id="password1" placeholder="Nhập password mới" />
                <small></small>
            </div>
            ...
            <div class="form-field">
                ...
                <input type="password" name="confirm-password" id="confirm-password"
                    placeholder="Confirm password chưa đúng" />
                <small></small>
            </div>
            <div class="form-field">
                <input type="submit" value="Sign Up" class="btn" name="btnClick" />
            </div>
        </form>
    </div>
    <!-- <script>
