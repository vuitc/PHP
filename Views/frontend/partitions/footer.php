...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p>E-Shopper là điểm đến hàng đầu cho những người yêu thích mua sắm trực tuyến. Với sự đa dạng về sản phẩm
                và dịch vụ, chúng tôi mang lại trải nghiệm mua sắm tuyệt vời nhất cho bạn.</p>
